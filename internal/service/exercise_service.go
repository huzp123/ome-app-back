...
import (
	...
	"ome-app-back/internal/model/constant"
)

// ExerciseService 运动服务
type ExerciseService struct {
	exerciseDAO *dao.UserExerciseDAO
}

// NewExerciseService 创建运动服务实例
func NewExerciseService(exerciseDAO *dao.UserExerciseDAO) *ExerciseService {
...
func (s *ExerciseService) CreateExercise(userID int64, req *CreateExerciseRequest) (*model.UserExercise, error) {
	// 验证运动类型
...
func (s *ExerciseService) GetExercise(userID, exerciseID int64) (*model.UserExercise, error) {
	return s.exerciseDAO.GetByID(userID, exerciseID)
}

// GetExerciseHistory 获取运动历史记录
func (s *ExerciseService) GetExerciseHistory(userID int64, req *ExerciseHistoryRequest) ([]model.UserExercise, error) {
	// 解析日期
...
func (s *ExerciseService) GetTodayExercises(userID int64) ([]model.UserExercise, error) {
	return s.exerciseDAO.GetTodayExercises(userID)
}

// UpdateExercise 更新运动记录
func (s *ExerciseService) UpdateExercise(userID, exerciseID int64, req *UpdateExerciseRequest) (*model.UserExercise, error) {
	// 先获取现有记录
