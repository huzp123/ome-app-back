...
type MoodService struct {
	moodDAO *dao.MoodRecordDAO
}

// NewMoodService 创建心情服务实例
func NewMoodService(moodDAO *dao.MoodRecordDAO) *MoodService {
	return &MoodService{
		moodDAO: moodDAO,
	}
}
...
// CreateMood 创建心情记录
func (s *MoodService) CreateMood(userID int64, req *CreateMoodRequest) (*model.MoodRecord, error) {
	// 验证情绪等级
...
// GetMood 获取单个心情记录
func (s *MoodService) GetMood(userID, moodID int64) (*model.MoodRecord, error) {
	return s.moodDAO.GetByID(userID, moodID)
}

// GetMoodHistory 获取心情历史记录
func (s *MoodService) GetMoodHistory(userID int64, req *MoodHistoryRequest) ([]model.MoodRecord, error) {
	// 解析日期
...
func (s *MoodService) GetTodayMoods(userID int64) ([]model.MoodRecord, error) {
