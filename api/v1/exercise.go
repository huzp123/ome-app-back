...
func NewExerciseAPI(exerciseService *service.ExerciseService) *ExerciseAPI {
	return &ExerciseAPI{
...
func (api *ExerciseAPI) CreateExercise(c *gin.Context) {
	...
	var req service.CreateExerciseRequest
...
func (api *ExerciseAPI) GetExerciseHistory(c *gin.Context) {
	...
	var req service.ExerciseHistoryRequest
...
func (api *ExerciseAPI) UpdateExercise(c *gin.Context) {
	...
	var req service.UpdateExerciseRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		errcode.InvalidParams.WithDetails(err.Error()).Response(c)
		return
	}
